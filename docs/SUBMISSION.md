...
- **Content bonus link**: DONE. https://dev.to/stephensook/how-i-built-curtail-a-governed-agent-fleet-for-water-curtailment-where-the-human-always-signs-3861, recorded in `submission_links.json` and on the Devpost form.
